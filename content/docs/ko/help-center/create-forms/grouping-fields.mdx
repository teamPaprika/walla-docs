...
<img src="/images/guides/manage-forms/field-group-default-view.png" alt="기본 보기에서 페이지 나누기로 구분한 편집 화면과 응답자 URL 화면 비교" style={{ width: "100%", borderRadius: "8px", marginTop: "12px", marginBottom: "12px", border: "1px solid var(--border)" }} />
