...
| 발송 | `POST /forms/{formId}/delivery/recipients` | 수신자 등록 |
| 발송 | `PATCH /forms/{formId}/delivery/recipients` | 수신자 정보 수정 |
| 발송 | `POST /forms/{formId}/delivery/send` | 등록된 수신자에게 전송 |
...
| 응답 내보내기 | `POST /forms/{formId}/exports/responses` | 폼 응답을 Parquet 파일로 내보내기 |
| 응답 내보내기 | `POST /forms/{formId}/exports/field-definitions` | 폼 필드 정의를 Parquet 파일로 내보내기 |
