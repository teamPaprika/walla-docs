...
<Steps>
    ...
    ☑️ No logic is currently set up. The default setting for "Move to" on the right is "Next Question," meaning that any
    answer will move the survey to the next question.

    ![Untitled]

    ☑️ If Question 0's "Move to" is set to Question 2, it directly connects Question 0 to Question 2, skipping Question
    1.
    ...
    ☑️ Let's take a look at the sample survey. You'll see that the first question, "Please select your gender," doesn't
    appear.

    ![Untitled]

    ☑️ Let's go back to the beginning and clear all logic. Then, I'll set the "Move to" value for Question 2 to Question
