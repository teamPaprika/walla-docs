...
<Steps>
    ...
    ![Untitled](/images/project&analysisAndReward/manageProject/en/0.png)

    ### List projects based on criteria like 'Last Modified Date,' 'Creation Date,' 'Number of Responses,' 'Title,' etc.

    ![Untitled](/images/project&analysisAndReward/manageProject/en/1.png)
    ...
    ![Untitled](/images/project&analysisAndReward/manageProject/en/2.png)
...
<Steps>
    ...
    ![Untitled](/images/project&analysisAndReward/manageProject/en/3.png)

    ### Select the destination workspace and press 'Move'.

    ![Untitled](/images/project&analysisAndReward/manageProject/en/4.png)
    ...
    ![Untitled](/images/project&analysisAndReward/manageProject/en/5.png)
...
<Steps>
    ...
    ![Untitled](/images/project&analysisAndReward/manageProject/en/6.png)

    ### 'Archived projects are moved to the archive.
    - Archiving displays 'Project deleted.' To undo, click 'Undo'.

    ![Untitled](/images/project&analysisAndReward/manageProject/en/7.png)
    ...
    ![Untitled](/images/project&analysisAndReward/manageProject/en/8.png)

    ![Untitled](/images/project&analysisAndReward/manageProject/en/9.png)

    ### Selecting 'Undo' in the archive returns the project to the 'Projects' tab in the workspace.

    ![Untitled](/images/project&analysisAndReward/manageProject/en/10.png)
