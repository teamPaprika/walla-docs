...
b. **Client Key, Secret Key**: The client and secret keys can be found on the Toss Payments Developer Center (https://developers.tosspayments.com/) under 'My Development Information' or by checking the payment widget integration key, which is displayed in blue in the payment field.
