...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F0.png)
...
<Steps>
    ...
    ![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F1.png)
    ...
    ![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F2.png)
    ...
    ![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F3.png)

    ![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F4.png)
    ...
    ![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F5.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F6.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F7.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F8.png)

- If you want to request file uploads from survey respondents, Add the "File" field.
- Each plan has a limit on the file size that can be uploaded. Please refer to [this page](/en/Features_And_Plan_Price/Plans) for more details.
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F9.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F10.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F11.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F12.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F13.png)
...
- [The Perfect Method for Collecting Location Data](https://home.walla.my/blog-global/how-to-collect-location-data-in-walla-eng)

## 2. Personal Information Field (Personal Information Collection and Use Consent Form Field)

![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F14.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F15.png)

- To divide sections in a survey, use the 'Section Field'.

## 4. Description Field

![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F16.png)

- For survey explanations, use the 'Description Field'.

## 5. Image Description Field

![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F17.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F18.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F19.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F20.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F21.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F22.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F23.png)
...
![Untitled](https://paprikastorage.com/images/settingUpFields/en/26.png)
![Untitled](https://paprikastorage.com/images/settingUpFields/en/27.png)

- The 'Multiple Choice Grid Field' allows you to create a grid-style field where the same set of options can be provided for multiple items.
  - ex) If you want to survey the preference for 'Korean', 'Japanese', 'Western', 'Chinese', and 'Snacks', instead of creating five separate linear scale questions, try using the 'Multiple Choice Grid Field'. You can quickly gather preferences by entering the menu types in the rows and the preference scales in the columns.

- If you enable 'Multiple Selection' in the 'Options' on the right side of the survey editing screen, you can allow multiple choices for a single item.
  - ex) With 'Multiple Selection' enabled, respondents can select both 'Neutral' and 'Very Good' at the same time.

- You can restrict duplicate column selections to allow ranking of items.

![Untitled](https://paprikastorage.com/images/settingUpFields/en/29.png)

- Without the 'Restrict Duplicate Column' option, respondents could select '1st place' for all items. By enabling the 'Restrict Duplicate Column' option, each choice can only be selected once.

## 4. Dropdown Field

![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F25.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F31.png)

- You can group multiple types of questions into one using 'Multiple Fields'.
- Select the type of field such as short answer, long text, photo, or file, and write the corresponding question for each field.
- Logic cannot be applied to fields within a Multiple Fields.

## 📅 Date & Time

## 1. Date Field

![Untitled](https://paprikastorage.com/images/settingUpFields/en/30.png)
...
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fen%2F28.png)
...
<aside style={{backgroundColor: 'red', padding: '16px', background: 'rgb(241, 241, 239)', borderRadius: '4px', fontSize: '16px', lineHeight: '1.5', fontWeight: '500', margin: '20px 0px'}}>
    💡 An exit field is a field that prevents respondents from continuing before submission. You can set various logic in the exit field to utilize it in different ways.
</aside>

#### Please add an exit field.
You can freely insert text, images, etc., into the exit field.
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fko%2F32.png)

#### Set the logic for the filter question.
- You cannot set logic for the exit field itself.
- If the default move is 'Next Question', it will conflict with the 'Exit Field' that appears immediately after. Be sure to specify the default move.
- For example, in a survey targeting people in their 20s, if you want to exclude respondents who are not in their 20s, set the logic in the question asking about age.
  - Default move: Q2. What is your occupation?
  - Logic 1: Select 'Teens' → Move to 'Exit Field'
![Untitled](https://paprikastorage.com/images%2FsettingUpFields%2Fko%2F33.png)

#### Shall we check?

- You can move respondents who selected 'Teens' to the exit field and inform them '**You are not eligible to respond!**'.
- Respondents who selected '20s' can proceed with the survey normally.
